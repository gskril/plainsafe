...
- **Demo video:** Claude Code recorded the demo scenes by driving the production build with Playwright against a local Sepolia fork (throwaway keys, test wallets), assembled them with ffmpeg, and wrote the voiceover script in [`docs/demo/voiceover.md`](docs/demo/voiceover.md). The voice is the author's.
